...
def extract_files():
        ...
        for vid_class in class_folders:
            ...
            for video_path in class_files:
                ...
                if not check_already_extracted(video_parts):
                    ...
                    #############################################
                    #use ffmpeg in windows: 1. setup ffmpeg; 2. add ffmpeg/bin to system path
                    #to hide prompt cmd, use shell=true
    ...
    #############################################
    #windows will add \n at the end of a line, so there will be a blank line
...
def get_video_parts(video_path):
    ...
    #############################################
    #replace "\\" with to "/", i.e. change windows style to linux style
